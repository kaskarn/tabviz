...
describe("typography → cssVars integration", () => {
  it("emits all 60 typography tokens (10 roles × 6 props)", () => {
    const r = resolveTheme(createWire({ brand: "#0099CC" }, "test"));
  ...
  it("size reflects type_scale_ratio", () => {
    const r1 = resolveTheme(createWire({ brand: "#0099CC", type_base_size: 14, type_scale_ratio: 1.2 }, "t"));
    const r2 = resolveTheme(createWire({ brand: "#0099CC", type_base_size: 14, type_scale_ratio: 1.5 }, "t"));
  ...
  it("body size == type_base_size", () => {
    const r = resolveTheme(createWire({ brand: "#0099CC", type_base_size: 16 }, "t"));
