...
<style>
  ...
  .search-input:focus {
    border-color: var(--tv-accent, var(--tv-accent, #3b82f6));
    box-shadow: 0 0 0 2px color-mix(in srgb, var(--tv-accent, var(--tv-accent, #3b82f6)) 15%, transparent);
  }
  ...
  .footer-toggle input[type="checkbox"] {
    accent-color: var(--tv-accent, var(--tv-accent, #2563eb));
    cursor: pointer;
    margin: 0;
  }
  ...
  .node-btn.active {
    background: color-mix(in srgb, var(--tv-accent, var(--tv-accent, #3b82f6)) 12%, var(--tv-surface-bg, #fff));
    color: var(--tv-accent, var(--tv-accent, #3b82f6));
    font-weight: 600;
  }
