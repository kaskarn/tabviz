...
DENSITY_PRESETS <- list(
  compact = list(
    row_height = 20, header_height = 26, padding = 8, container_padding = 10,
  ...
  comfortable = list(
    row_height = 24, header_height = 32, padding = 12, container_padding = 10,
  ...
  spacious = list(
    row_height = 30, header_height = 40, padding = 16, container_padding = 10,
