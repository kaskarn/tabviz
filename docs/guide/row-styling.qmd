...
- **`marker_color = "col" \| ~ formula`** — for exact-color control (categorical palettes, colorblind-safe encodings, brand colors). Wins over the semantic cascade. Returns `NA` to fall through to the semantic layer.
:::
