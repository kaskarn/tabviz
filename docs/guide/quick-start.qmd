...
tabviz ships with seven publication-ready themes — four journal-style presets and three illustrative LOTR-flavored themes:
...
tabviz(meta_data[1:3, ],
  ...
  theme = web_theme_nejm(), title = "JAMA"
)
...
tabviz(meta_data[1:3, ],
  ...
  theme = web_theme_nejm(), title = "Lancet"
)
```

**Journal presets**: `web_theme_nejm()` (default), `web_theme_nejm()`, `web_theme_nejm()`, `web_theme_aurora()`.
**LOTR presets**: `web_theme_dwarven()`, `web_theme_dwarven()`, `web_theme_dwarven()`.
...
| [Themes](themes.qmd) | Preset themes (4 journal + 3 LOTR) and customization |
