...
webforest offers two equivalent ways to style your plots—both produce identical results.
...
|-------|-------------------|
| [Forest Plots](forest-plots.qmd) | Data mapping, markers, axis control, exporting |
...
| [Row Groups](row-groups.qmd) | Organize studies into collapsible groups |
| [Themes](themes.qmd) | Preset themes and customization |
| [The Fluent API](fluent-api.qmd) | Build plots step-by-step with set_*() functions |
