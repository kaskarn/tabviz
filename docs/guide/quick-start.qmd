...
**Journal presets**: `web_theme_cochrane()` (default), `web_theme_lancet()`, `web_theme_jama()`, `web_theme_dark()`.
**LOTR presets**: `web_theme_dwarven()`, `web_theme_elvish()`, `web_theme_hobbit()`.
