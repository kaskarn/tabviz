...
Throughout this guide, you've seen styling via direct arguments to `forest_plot()`. This chapter introduces the **fluent API**—a pipe-based alternative that lets you build and modify plots step by step using `set_*()` functions.
