...
tabviz(
  ...
  columns = list(
    ...
    col_interval("delay_vs_avg", "delay_lower", "delay_upper", header = "Delay (95% CI)"),
...
climate_temps |>
  ...
  tabviz(
    ...
    columns = list(
      ...
      col_interval("anomaly", "lower", "upper", header = "Anomaly (95% CI)"),
...
- [Gallery](../gallery/index.qmd) — Full examples using these datasets
