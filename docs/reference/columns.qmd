...
Apply per-cell styling to a column after spec creation. See [The Fluent API](../guide/fluent-api.qmd) guide.
...
- [The Fluent API](../guide/fluent-api.qmd) for pipe-based styling
