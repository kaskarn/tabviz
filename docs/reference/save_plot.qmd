...
```r
save_split_forest(x, path, format = c("svg", "pdf", "png"),
...
data |>
  ...
  save_split_forest("output/plots", format = "svg")
...
- [split_forest()](split_forest.qmd) for creating split forests
- [Forest Plots Guide](../guide/forest-plots.qmd#exporting) for detailed export workflows
