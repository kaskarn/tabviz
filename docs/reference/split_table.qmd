...
- `save_split_table()` - Export all sub-plots to a directory
- `web_spec()` - Create a plot specification

## See Also

- [Split Plots Guide](../guide/split-plots.qmd) for detailed usage
- [Gallery - Advanced Examples](../gallery-advanced.qmd) for visual examples
