...
| `level1_border_bottom` | `TRUE` | Show bottom border on level 1 |
| `level2_font_size` | `"0.9375rem"` | Font size for second-level groups |
| `level2_font_weight` | `600` | Font weight for second-level groups |
| `level2_background` | `NULL` | Background color (NULL = 10% primary opacity) |
| `level2_border_bottom` | `TRUE` | Show bottom border on level 2 |
| `level3_font_size` | `"0.875rem"` | Font size for third-level groups |
| `level3_font_weight` | `500` | Font weight for third-level groups |
