...
| `set_colors(interval=, interval_positive=, interval_negative=, interval_neutral=, interval_line=)` | `ci_marker_fill=, ci_marker_positive=, ci_marker_negative=, ci_marker_neutral=, ci_line=` | `set_colors()` |
