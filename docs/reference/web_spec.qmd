...
```r
web_effect(point, lower, upper, label = NULL, color = NULL)
```
...
| `enable_sort` | Enable column sorting |
| `enable_collapse` | Enable group collapsing |
| `enable_select` | Enable row selection |
| `enable_hover` | Enable hover effects |
| `enable_resize` | Enable column resizing |
| `enable_export` | Enable download/export button |
