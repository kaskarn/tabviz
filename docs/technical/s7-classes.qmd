...
(`neutral`, `brand`, `primary_deep`, `accent`, `accent_deep`). Tier 2 data
derivation reads only data inputs (`series_anchors`, `status_*`) plus
`surface.base` for muted blends. The two cascades meet only at
`WebTheme` reassembly.
