...
Two journal-style treatments of the same underlying forest-plot structure. The only thing that changes is the theme (`web_theme_jama`, `web_theme_lancet`) and the row/column grouping — use these as drop-in templates for manuscript figures.
