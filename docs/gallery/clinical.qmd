...
tabviz(
  ...
  title = "Cardiovascular Outcomes Meta-Analysis"
)
```
...
tabviz(multi_effect,
  ...
  columns = list(
    ...
    col_forest(
      effects = list(
        web_effect("itt_hr", "itt_lo", "itt_hi",
                   label = "ITT", color = "#2563eb"),
        web_effect("pp_hr", "pp_lo", "pp_hi",
...
tabviz(
  ...
  annotations = list(
    ...
    forest_refline(0.85, label = "Pooled", style = "dashed", color = "#2563eb")
  ),
  title = "Cochrane Review: Cardiovascular Outcomes"
)
```
