...
::: {.callout-tip}
## Theme Variations
The same data structure works with any theme. Try `web_theme_lancet()`, `web_theme_cochrane()`, or `web_theme_cochrane()` for different journal styles. See [Feature Showcases](showcases.qmd#all-theme-variants) for a visual comparison of all 9 built-in themes.
:::
