...
| 11 | **C1** — forestStore decomposition (~4-5 weeks; long pole) | 🟡 in progress (6 of 11 slices). source (Q8) + cells (0c-PR13) + theme (0c-PR14) + axis (0c-PR15) + sort-filter (0c-PR16) + **rows-groups (0c-PR17)**. 84 vitest unit tests across slices. `$lib/filter-sort-utils.ts` extracted earlier. Main store has shed ~1200 lines net. Next: semantics. |
