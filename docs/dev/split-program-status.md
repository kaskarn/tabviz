...
| 11 | **C1** — forestStore decomposition (~4-5 weeks; long pole) | 🟡 in progress (3 of 11 slices). source (0c-PR0 / 23e18b4) + cells (0c-PR13) + **theme (0c-PR14)**. 34 vitest unit tests across the three slices. All gates green. Next: axis — the cross-slice $derived spike. |
