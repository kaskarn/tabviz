...
| 3 | **heatmap** | magic-number | value-text font DOM `--tv-text-label-size`≈0.75× vs SVG `fontSize*0.9`; SVG insets 2px (visible gutter) DOM fills; dark-text DOM hardcodes `#1a1a1a` vs SVG `readContentPrimary`. `CellHeatmap.svelte:103,131-136` ↔ `heatmap-svg-renderer.ts:85,94,102` | OPEN |
